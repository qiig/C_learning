...
// test
data1:  undirected graph
    6 6 0 0 1 1 0 2 1 0 5 1 1 2 1 1 4 1 2 3 1
res1:
    ...
    (1, 4) 1
    (2, 3) 1
data2:  undirected network graph
    6 9 0
    0 1 34
    0 2 46
    0 5 19
...
res2:
    ...
    (2, 5) 25
    (4, 5) 26
data3:  undirected network graph
    6 9 0
    0 1 34
    0 2 46
    0 5 19
...
data4:  directed network graph
    ...
    3 4 60
res4:
    depth first traverse: ABCED
    breadth first traverse: ABDEC
    prim:
    0 -> 1 : 10
    0 -> 3 : 30
    0 -> 4 : 100
...
class MGraph{
    public:
        MGraph(DT a[], int n, int e, int isDire);   // vertices array, number of vertices, number of edges
        ~MGraph(){};
